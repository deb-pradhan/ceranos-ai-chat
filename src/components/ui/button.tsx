...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-focus-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:shrink-0 active:scale-95 touch-target-sm",
  {
    variants: {
      variant: {
      ...
      size: {
        default: "h-11 px-4 py-2 rounded-lg touch-target",
        sm: "h-9 px-3 py-1.5 rounded-md text-xs touch-target-sm", 
        lg: "h-12 px-6 py-3 rounded-xl text-base touch-target",
